...
// The bookmarklet creates a <script> tag pointing at a user-provided URL.
// Default placeholder URL — user replaces with their hosted path.
const BUNDLE_URL = 'https://YOUR_HOST/audit-panel.iife.js';
